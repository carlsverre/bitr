...
var sessions={} // our data store
  , timeout // the id of a pending setTimeout, if any, which will delete any expired session objects

exports.lookupOrCreate=lookupOrCreate

// normally this will not be used, but it's there if you want to access the session store from a debugger
...
// the return value is a string of length ⌈bits/6⌉
function randomString(bits){var chars,rand,i,ret
  chars='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/' // base64 alphabet
  ret=''
...
// this function name is horrible, makes it sound like it's setting something; however the header is called Set-Cookie, so...
Session.prototype.setCookieHeader=function(){var parts
  parts=['SID='+this.id]
